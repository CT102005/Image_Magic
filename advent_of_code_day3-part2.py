...
new_gammaray = [gammaray for gammaray in gammarays if gammaray[0] == "0"]
...
new_gammaray3 = [gammaray for gammaray in new_gammaray2 if gammaray[2] == "0"]
...
new_gammaray5 = [gammaray for gammaray in new_gammaray4 if gammaray[4] == "0"]
...
new_gammaray7 = [gammaray for gammaray in new_gammaray6 if gammaray[6] == "0"]
...
print(new_gammaray, len(new_gammaray))
print(new_gammaray2, len(new_gammaray2))
print(new_gammaray3, len(new_gammaray3))
print(new_gammaray4, len(new_gammaray4))
print(new_gammaray5)
print(new_gammaray6)
print(new_gammaray7)
print(new_gammaray8)
