    ...
    def main() -> None:
        ...
        while not done:
            ...
            if score < winscore:
                ...
                screen.blit(font_medium.render("Jump on the clouds to aim at the blocks better", True, BLACK),
                            (100, 125))
                screen.blit(font_medium.render("Jump underneath a cloud to warp through", True, BLACK), (885, 210))
                screen.blit(font_medium.render("Stay too long on a cloud and you'll fall through", True, BLACK),
                            (850, 250))
            ...
            if score >= winscore:
                ...
                if pygame.mouse.get_pressed(3)[0]:
                    if (button.rect.left < mouse_pos[0] < button.rect.right) and (
                            button.rect.top < mouse_pos[1] < button.rect.bottom):
                        done = True
